<div class="wrapper">
			...
			<div class="parallax text-center bg-color">
				<div class="parallax-pattern-overlay">
					<div class="container text-center heightpadding">
						...
						<h2 class="display-2">Change starts with you.</h2>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="about-us" id="about-us">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<p><strong>Pagta-o</strong>, a Kinaray-a word which translates to "giving", is an online platform whose goal is to help individuals and organizations initiate outreach programs in places that have been affected by natural disasters, corrupted by pollution, or torn by the destruction of war. </p>
				</div>
			</div>
		</div>
	</section>
